...
public class FeedItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getItemViewType() == TattooListAdapter.VIEW_TYPE_ITEM) {
            if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
                lastAddAnimatedItem++;
               runEnterAnimation((TattooListAdapter.ViewHolder) viewHolder);
                return false;
            }
        }
    ...
    private void runEnterAnimation(final TattooListAdapter.ViewHolder holder) {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof FeedItemHolderInfo) {
            ...
            TattooListAdapter.ViewHolder holder = (TattooListAdapter.ViewHolder) newHolder;


           // int count = Integer.parseInt(holder.getItem().getTattooLikes());
         //  updateLikesCounter(holder,count );
           if (TattooListAdapter.ACTION_LIKE_BUTTON_CLICKED.equals(feedItemHolderInfo.updateAction)) {
    ...
    private void animateHeartButton(final TattooListAdapter.ViewHolder holder) {
        ...
        bounceAnimY.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
             //  holder.btnLike.setImageResource(R.drawable.ic_heart_red);
                holder.btnLike.setImageResource(holder.getItem().getIsLiked() == 1 ? R.drawable.ic_heart_red : R.drawable.ic_heart_outline_grey);
            }
    ...
    private void updateLikesCounter(TattooListAdapter.ViewHolder holder, int toValue) {
       /* String likesCountTextFrom = holder.likeCount.getResources().getQuantityString(
                R.plurals.likes_count, toValue - 1, toValue - 1
        );
        holder.likeCount.setCurrentText(likesCountTextFrom);

        String likesCountTextTo = holder.likeCount.getResources().getQuantityString(
                R.plurals.likes_count, toValue, toValue
        );*/
        holder.likeCount.setText(String.valueOf(toValue));
    }

    private void animatePhotoLike(final TattooListAdapter.ViewHolder holder) {
    ...
    private void dispatchChangeFinishedIfAllAnimationsEnded(TattooListAdapter.ViewHolder holder) {
    ...
    private void resetLikeAnimationState(TattooListAdapter.ViewHolder holder) {
