...
*/
       ...
       /* Glide.with(this).load(urlProfileImg)
        ...
        Picasso.with(this).load(urlProfileImg)
                .fit()
                .centerCrop()
                .error(R.drawable.ic_user)
                .into(imgProfile);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_about_us:
                      ...
                      //  startActivity(new Intent(ProfileScreen.this, AboutUsActivity.class));
                        drawer.closeDrawers();
                        return true;
                    case R.id.nav_privacy_policy:
                        // launch new intent instead of loading fragment
                       // startActivity(new Intent(ProfileScreen.this, PrivacyPolicyActivity.class));
                        drawer.closeDrawers();
                        return true;
                    default:
                        navItemIndex = 0;
